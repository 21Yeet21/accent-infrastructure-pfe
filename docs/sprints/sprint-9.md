...
# \# Incrémenter config\_version de 1
...
# pveceph pool create vm-pool --add\_storages
...
# ha-manager set vm:101 --max\_restart 2 --max\_relocate 2
...
# !\[État initial — Ceph HEALTH\_OK](./images/Pasted%20image%2020260522095236.png)
...
# !\[Ceph après restauration — HEALTH\_OK, 3 OSDs up, 33 PGs active+clean](./images/Pasted%20image%2020260522101108.png)
...
# \## Perspectives — Sprint 9

# 

# Le PoC HA étant validé, le Sprint 9 sera consacré à :

# 

# \- \*\*Migration des VMs critiques\*\* — déplacer S1, S2 et les autres services sur le cluster HA

# \- \*\*Optimisation Ceph\*\* — ajuster les paramètres de réplication (size=3, min\_size=2) et les pools

# \- \*\*Monitoring du cluster\*\* — intégrer Proxmox et Ceph dans la stack Prometheus/Grafana

# \- \*\*Documentation des procédures\*\* — runbooks pour les scénarios de panne et de maintenance
