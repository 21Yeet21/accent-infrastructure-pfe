...
# cp node\_exporter-1.7.0.linux-amd64/node\_exporter /usr/local/bin/

# 

# \# OpenTelemetry Collector

# wget https://github.com/open-telemetry/opentelemetry-collector-releases/releases/download/v0.96.0/otelcol-contrib\_0.96.0\_linux\_amd64.tar.gz
...
# wget https://github.com/oliver006/redis\_exporter/releases/download/v1.58.0/redis\_exporter-v1.58.0.linux-amd64.tar.gz

# tar xvf redis\_exporter-v1.58.0.linux-amd64.tar.gz

# cp redis\_exporter-v1.58.0.linux-amd64/redis\_exporter /usr/local/bin/
