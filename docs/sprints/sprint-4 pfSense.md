...
![Installation pfSense — étape 1](./images/Pasted%20image%2020260515194507.png) ![Installation pfSense — étape 2](./images/Pasted%20image%2020260515194818.png)
...
![Login pfSense](./images/Pasted%20image%2020260511211114.png)
...
![Configuration des VLANs](./images/Pasted%20image%2020260522134249.png)
...
![Assignments des interfaces](./images/Pasted%20image%2020260522134235.png)
...
![Configuration DHCP CLIENTS](./images/Pasted%20image%2020260511220953.png)
...
![Règles firewall CLIENTS](./images/Pasted%20image%2020260522134112.png)

### Règles DMZ

![Règles firewall DMZ](./images/Pasted%20image%2020260522134057.png)

### Règles LAN

![Règles firewall LAN](./images/Pasted%20image%2020260522134033.png)
...
![Test connectivité internet](./images/Pasted%20image%2020260512195227.png)
...
![Désactivation hardware offloading](./images/Pasted%20image%2020260520175909.png)
...
![Installation Suricata](./images/Pasted%20image%2020260520054204.png)
...
![Configuration ETOpen](./images/Pasted%20image%2020260520181138.png) ![Mise à jour des règles](./images/Pasted%20image%2020260520181551.png)
...
![Assignment des interfaces Suricata](./images/Pasted%20image%2020260520182335.png)
...
![Catégories de règles Suricata](./images/Pasted%20image%2020260520181852.png)
...
![Scan nmap depuis S1](./images/Pasted%20image%2020260520190137.png)

Les alertes apparaissent dans Services → Suricata → Alerts :

![Alertes Suricata détectées](./images/Pasted%20image%2020260520190506.png)
...
![Création du CA ACCENT-CA](./images/Pasted%20image%2020260522112624.png)
...
![Création du certificat serveur](./images/Pasted%20image%2020260522112724.png)
...
![Configuration serveur OpenVPN](./images/Pasted%20image%2020260522133053.png)
...
![Règles firewall créées par le wizard](./images/Pasted%20image%2020260522113152.png)

Serveur OpenVPN créé et actif :

![Serveur OpenVPN actif](./images/Pasted%20image%2020260522132917.png)

Règles OpenVPN tab :

![Règles OpenVPN](./images/Pasted%20image%2020260522134153.png)

Règles WAN — UDP 1194 :

![Règle WAN UDP 1194](./images/Pasted%20image%2020260522123903.png)
...
![Création utilisateur VPN](./images/Pasted%20image%2020260522113428.png)

### Export de la configuration client

Installation du package `openvpn-client-export` :

![Installation openvpn-client-export](./images/Pasted%20image%2020260522114903.png)

Export du fichier `.ovpn` avec Host Name Resolution pointant vers `192.168.140.179` (IP publique ISP-Router) :

![Export configuration client .ovpn](./images/Pasted%20image%2020260522115105.png)
...
![Connexion VPN établie depuis Node4](./images/Pasted%20image%2020260522120934.png)

Node4 obtient l'IP `192.168.70.2/24` sur tun0 :

![Node4 connecté avec IP 192.168.70.2](./images/Pasted%20image%2020260522140832.png)

### Validation de la connectivité

Ping depuis vpnclient vers les ressources internes :

![Ping depuis vpnclient vers ressources internes](./images/Pasted%20image%2020260522132732.png)

Statut OpenVPN côté pfSense — client connecté :

![Statut OpenVPN — client connecté](./images/Pasted%20image%2020260522140620.png)
